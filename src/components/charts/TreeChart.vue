<template>
  <div ref="treeChart" class="gauge-chart"></div>
</template>
...
.gauge-chart {
  width: 100%;
  height: 100%;
  min-height: 500px; /* 필요에 따라 높이를 조정 */
}
</style>
